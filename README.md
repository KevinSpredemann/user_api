...
Todas as rotas de GET, PATCH e DELETE em /users usam JwtAuthGuard.

Para acessá-las, inclua no header:
...
Configure o arquivo .env com as variáveis do Railway:

MYSQLHOST=seu-host-do-railway
MYSQLPORT=3306
